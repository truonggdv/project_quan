...
<head>
    ...
    <!--//-------Seo--------->
    <title>Shop bán hàng thương mại điện tử</title>
    ...
    <![endif]-->       
    <link rel="shortcut icon" href="{{('public/frontend/images/logo1.ico')}}">
...
<body>
                ...
                <div class="row">
                    <div class="col-sm-4">
                        <div class="logo pull-left">
                            <a href="{{URL('/trang-chu')}}"><img src="{{url('public/frontend/images/logo.png')}}" alt="" /></a>
                        </div>
                    </div>
                    <div class="col-sm-8">
    ...
    <footer id="footer"><!--Footer-->
                    ...
                    <div class="col-sm-2">
                        <div class="single-widget">
                            ...
                            <ul class="nav nav-pills nav-stacked">
                                ...
                                <li><a href="#">Chính sách hoàn phí</a></li>
        ...
        <div class="footer-bottom">
            <div class="container">
                <div class="row">
                    <p class="pull-left">SHOP BÁN HÀNG THƯƠNG MẠI ĐIỆN TỬ</p>                    
                </div>
            </div>
        </div>
